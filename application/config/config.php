...
|
*/
$config['base_url'] = 'http://200.98.136.138:8000';
/*
|--------------------------------------------------------------------------
| Index File
|--------------------------------------------------------------------------
...
$config['sess_driver'] = 'files'; // Driver de sessão
$config['sess_cookie_name'] = 'ci_session'; // Nome do cookie de sessão
$config['sess_expiration'] = 7200; // Tempo de expiração da sessão em segundos
$config['sess_save_path'] = sys_get_temp_dir(); // Caminho para a pasta temporária do sistema
$config['sess_match_ip'] = FALSE; // Verificar se o IP do usuário é o mesmo ao acessar a sessão
$config['sess_time_to_update'] = 300; // Tempo para atualizar a sessão em segundos
$config['sess_regenerate_destroy'] = FALSE; // Destruir a sessão antiga ao regenerar o ID da sessão
