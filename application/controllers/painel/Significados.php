...
class Significados extends MS_Controller
{

    private $tela = 'painel/significados/';

    function __construct()
    {
        parent::__construct();
        $this->load->model('SignificadosModel', 'registro', FALSE);
    ...
    function DataGridResult($get)
    {
        ...
        if ($get['description'] != '')
            $like[] = ['campo' => 'upper(significado)', 'valor' => strtoupper($get['description'])];
    ...
    function cadastro($id = null) 
    {
        ...
        $data = array(
            'titulo'   => $this->titulo,
            'tela'     => $this->tela, 
            'termos' => $this->termos->filtrar([])->result_object(),
