...
class Obrigacoes extends MS_Controller
{

    private $tela = 'painel/obrigacoes/';

    function __construct()
    {
        parent::__construct();
        $this->load->model('ObrigacaosModel', 'registro', FALSE);
    ...
    function DataGridResult($get)
    {
        ...
        if (@$get['description'] != '')
            $like[] = ['campo' => 'upper(name)', 'valor' => strtoupper($get['description'])];
        $ordem = ['campo' => 'name', 'ordem' => 'ASC'];
